...
(() => {
  ...
  async function loadPackage(metadata) {
    ...
    async function runWithFS(Module) {
      ...
      async function processPackageData(arrayBuffer) {
        ...
        Module["removeRunDependency"]("datafile_out/index.data");
      }
      Module["addRunDependency"]("datafile_out/index.data");
  ...
  loadPackage({
    "files": [ {
      ...
      "filename": "/assets/ground.jpg",
      "start": 23493,
      "end": 28733
    }, {
      "filename": "/assets/notempty",
      "start": 28733,
      "end": 28733
    }, {
      "filename": "/assets/pipe.png",
      "start": 28733,
      "end": 2139838
    } ],
    "remote_package_size": 2139838,
    "package_uuid": "sha256-4671ee72698c5b2ab9d8004ccf3bd3e52e5e8f7f9d32c3e546dd748b8ad63b2e"
  });
})();

// end include: /tmp/tmpt6jnmjqm.js
var arguments_ = [];
...
var ASM_CONSTS = {
  ...
  307192374: () => window.innerWidth,
  307192404: () => window.innerHeight
};

// Imports from the Wasm binary.
var _malloc, _free, _Load_, _main, ___funcs_on_exit, _fileno, _emscripten_builtin_memalign, _setThrew, __emscripten_stack_restore, __emscripten_stack_alloc, _emscripten_stack_get_current, __ZN6__asan9FakeStack17AddrIsInFakeStackEm, __ZN6__asan9FakeStack8AllocateEmmm, ___asan_loadN, ___asan_storeN, ___lsan_disable, ___lsan_enable, memory, __indirect_function_table, wasmMemory, wasmTable;

function assignWasmExports(wasmExports) {
  _malloc = wasmExports["malloc"];
  _free = wasmExports["free"];
  _Load_ = Module["_Load_"] = wasmExports["Load_"];
